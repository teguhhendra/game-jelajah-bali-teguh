...
const databaseKabupaten = {
    ...
    "buleleng": {
        ...
        profil: "Kabupaten Buleleng terletak di bagian utara Pulau Bali dengan ibu kota Singaraja. Nama 'Buleleng' berasal dari kisah Kerajaan Buleleng yang dipimpin oleh Ki Barak Panji Sakti pada abad ke-17. Wilayah ini dikenal sebagai Den Bukit karena berada di sebelah utara pegunungan Bali.",
        fotoProfil: "buleleng-profil.png",
        captionProfil: "Tugu Singa Ambara Raja - Ikon Kota Singaraja",

        "bentang-alam": { 
            "Pantai Lovina": { teks: "Ikon wisata bahari terkenal dengan atraksi lumba-lumba liar di pagi hari.", foto: "buleleng-lovina.png", caption: "Atraksi Lumba-lumba di Pantai Lovina" }, 
            "Danau Buyan": { teks: "Salah satu danau terbesar di Bali yang menjadi sumber air bagi pertanian dan perkebunan.", foto: "buleleng-buyan.png", caption: "Keasrian Danau Buyan" }, 
            "Pegunungan Munduk–Wanagiri": { teks: "Kawasan sejuk penghasil kopi, cengkeh, dan hortikultura dengan pemandangan indah.", foto: "buleleng-munduk.png", caption: "Kawasan Agrowisata Munduk" } 
        },
        "budaya": { 
            "Tradisi Megoak-Goakan": { teks: "Permainan khas Desa Panji yang mengenang strategi perang Ki Barak Panji Sakti.", foto: "buleleng-megoak.png", caption: "Tradisi Megoak-goakan" }, 
            "Kesenian Genjek": { teks: "Kesenian vokal khas Bali Utara yang mengandalkan harmoni suara manusia.", foto: "buleleng-genjek.png", caption: "Pertunjukan Genjek Buleleng" }, 
            "Tari Truna Jaya": { teks: "Tarian yang menggambarkan karakter pemuda yang energik dan penuh keberanian.", foto: "buleleng-trunajaya.png", caption: "Penari Truna Jaya" } 
        },
        "wisata": { 
            "Wisata Alam": { teks: "Pantai Lovina dan keindahan Air Terjun Gitgit yang asri.", foto: "buleleng-gitgit.png", caption: "Air Terjun Gitgit" }, 
            "Wisata Religi": { teks: "Pura Pulaki dan Pura Beji dengan ukiran khas Bali Utara yang sangat mendetail.", foto: "buleleng-pura-beji.png", caption: "Keindahan Ukiran Pura Beji" } 
        },
        "kuliner": { 
            "Blayag": { teks: "Makanan berbahan dasar beras dibungkus daun aren dengan kuah rempah.", foto: "buleleng-blayag.png", caption: "Blayag Buleleng" }, 
            "Siobak Singaraja": { teks: "Irisan daging dengan kuah rempah khas Bali Utara yang gurih.", foto: "buleleng-siobak.png", caption: "Siobak Singaraja" }, 
            "Sudang Lepet Jukut Undis": { teks: "Perpaduan unik hasil laut (sudang) dan hasil pertanian (jukut undis).", foto: "buleleng-sudang.png", caption: "Sudang Lepet Jukut Undis" } 
        },
        "potensi": { 
            "Agrowisata": { teks: "Pengembangan kopi, cengkeh, dan hortikultura di wilayah pegunungan.", foto: "buleleng-kopi.png", caption: "Perkebunan Kopi Buleleng" }, 
            "Wisata Sejarah": { teks: "Pengembangan situs sejarah Kerajaan Buleleng dan jejak kolonial.", foto: "buleleng-kirtya.png", caption: "Museum Gedong Kirtya" }, 
            "Wisata Bahari": { teks: "Konservasi lumba-lumba dan pengembangan ekonomi nelayan.", foto: "buleleng-nelayan.png", caption: "Aktivitas Nelayan Buleleng" } 
        },
        "quiz": [
